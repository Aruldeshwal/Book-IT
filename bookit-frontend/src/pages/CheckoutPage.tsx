...
interface CheckoutData {
    ...
    selectedSlot: any;
    quantity: number; // ADDED: Quantity from BookingSummary
    finalPrice: number; // ADDED: Final price calculated by BookingSummary
}
...
const CheckoutPage: React.FC = () => {
    ...
    const [priceSummary, setPriceSummary] = useState({
        originalPrice: initialData?.finalPrice || 0, // Start calculation from the price received from DetailsPage (which includes quantity)
        discountAmount: 0,
    ...
    const handlePromoValidation = async () => {
        ...
        try {
            // Note: We validate the promo against the current priceSummary.finalPrice, not the original experience price
            ...
            if (result.isValid) {
                ...
                // Reset discount if code is invalid, restoring the price from the start of the page load
                setPriceSummary({
    ...
    return (
        <div className="font-sans text-[#161616] pb-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 flex flex-col p-6 rounded-xl" style={{ background: '#EFEFEF' }}>
                    
                    <form onSubmit={handleSubmit} className="space-y-6">
                        
                        {/* Frame 60: Full Name and Email Row (gap: 24px) */}
                        ...
                        <div className="flex items-end space-x-4">
                            {/* Promo Code Input */}
                            <div className="grow">
                                <label htmlFor="promoCode" className="block text-sm font-normal leading-[18px] mb-2" style={{ color: '#5B5B5B' }}>Promo Code</label>
                            ...
                            <button type="button" onClick={handlePromoValidation} disabled={bookingLoading}
                                    className="bg-[#161616] text-[#F9F9F9] px-4 rounded-lg h-[42px] text-sm font-medium hover:opacity-90 transition disabled:opacity-50">
                        ...
                        {/* Frame 61: Terms Checkbox - REFACTORED FOR CUSTOM SVG */}
                ...
                <div className="lg:col-span-1 p-6 rounded-xl h-fit flex flex-col space-y-6" style={{ background: '#EFEFEF' }}>
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <div className="flex flex-col space-y-2.5">
                            ...
                            <div className="flex justify-between items-center h-5">
                                <span className="text-base font-normal" style={{ color: '#656565' }}>Experience</span>
                                <span className="text-base font-normal text-[#161616]">{initialData.experienceTitle}</span>
                            </div>
                    ...
                    {/* Pay and Confirm Button (Frame 55) */}
                    <button type="submit" onClick={handleSubmit} disabled={!isFormValid || bookingLoading}
                            className="bg-[#FFD643] rounded-lg h-11 text-base font-medium text-[#161616] hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed">
